...
mockup that disagrees with the display is now impossible.
    ...
    python3 davega/tools/mockup.py [out.html]
"""
import os
import sys
...
from gui.startup import Splash                               # noqa: E402
...
def main():
    out = sys.argv[1] if len(sys.argv) > 1 else "davega/mockups/index.html"
    keys = sorted(THEMES)
...
<p class="sub">Generated from the screen code by <code>davega/tools/mockup.py</code>,
